...
export class AssistantsService {
  ...
  async createAssistant(userId: string, assistantData: CreateAssistantDto): Promise<Assistant> {
  ...
  async getAssistant(userId: string, assistantId: number): Promise<Assistant | null> {
